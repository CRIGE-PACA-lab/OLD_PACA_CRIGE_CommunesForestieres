...
Drop table if exists "26XXX_wold50m"."26XXX_result3_mcd";
CREATE TABLE  "26XXX_wold50m"."26XXX_result3_mcd"(
...
DROP TABLE IF EXISTS "26XXX_wold50m"."26XXX_result3_mcd_temp"; --- table temporaire
CREATE TABLE "26XXX_wold50m"."26XXX_result3_mcd_temp" AS
...
from "26XXX_wold50m"."26XXX_result3" as a join r_cadastre_26XXX.parcelle_info as b --- sources : résultats de OLD50m ; cadastre
on st_intersects(a.geom, b.geom)
where b.codecommune = 'XXX';
COMMIT;

CREATE INDEX 
ON "26XXX_wold50m"."26XXX_result3_mcd_temp"
USING gist (geom); 
COMMIT;
...
ALTER TABLE "26XXX_wold50m"."26XXX_result3_mcd_temp"
...
UPDATE "26XXX_wold50m"."26XXX_result3_mcd_temp" as a
...
insert into "26XXX_wold50m"."26XXX_result3_mcd"(geom,comptcom_prop,nom_prop,obl_comptcom,obl_nom,obl_id_adresse,geo_parcelle,id_bati)
select geom,comptcom_prop,nom_prop,obl_comptcom,obl_nom,obl_id_adresse,geo_parcelle,id_bati
from "26XXX_wold50m"."26XXX_result3_mcd_temp";
COMMIT;
...
Update "26XXX_wold50m"."26XXX_result3_mcd" as a
set situation = case 
...
UPDATE "26XXX_wold50m"."26XXX_result3_mcd"
SET obl_statut = (
CASE 
...
DELETE FROM "26XXX_wold50m"."26XXX_result3_mcd"
WHERE ST_IsEmpty(geom) or surface_m2 = 0; 

DROP TABLE IF EXISTS "26XXX_wold50m"."26XXX_result3_mcd_temp"
